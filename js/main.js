(function () {
  ...
  if (contactForm) {
    ...
    whatsappNote.textContent =
      'Fill in your project details below — submit opens WhatsApp with your inquiry ready to send.';
    ...
    contactForm.addEventListener(
      ...
      function (e) {
        ...
        if (!message) {
          ...
          showToast(
            'Please tell us about your vision in the message box.'
          );
